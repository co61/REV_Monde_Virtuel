...
function createRoomDoors(scene){
	...
	porteGauche.position=new BABYLON.Vector3(25.75,0,15);
	...
	porteGauche2.position=new BABYLON.Vector3(15.75,0,15);
	...
	porteGauche3.position=new BABYLON.Vector3(5.75,0,15);
